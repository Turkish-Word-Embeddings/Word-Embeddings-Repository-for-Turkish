...
##
# This script reads the Turkish Movie dataset (its original form, which is also provided in this folder) and converts it to a CSV file.
##
...
train3 = df3[msk]
test3 = df3[~msk]
train3.to_csv("data/train_neutral.csv", index=False)
test3.to_csv("data/test_neutral.csv", index=False)
